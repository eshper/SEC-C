...
int main() {
  ...
  pointLight1.ambient = glm::vec3(1.8f, 1.8f, 1.8f);
  pointLight1.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  ...
  pointLight2.ambient = glm::vec3(1.8f, 1.8f, 1.8f);
  ...
  pointLight3.ambient = glm::vec3(1.8f, 1.8f, 1.8f);
  pointLight3.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  ...
  pointLight4.ambient = glm::vec3(1.8f, 1.8f, 1.8f);
  pointLight4.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  ...
  pointLight5.ambient = glm::vec3(1.8f, 1.8f, 1.8f);
  pointLight5.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  ...
  pointLight6.ambient = glm::vec3(1.8f, 1.8f, 1.8f);
  pointLight6.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  ...
  pointLight7.ambient = glm::vec3(1.8f, 1.8f, 1.8f);
  pointLight7.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  pointLight7.specular = glm::vec3(8.0f, 8.0f, 8.0f);
  pointLight7.constant = 1.0f;
  pointLight7.linear = 0.09f;
  ...
  pointLight8.ambient = glm::vec3(1.8f, 1.8f, 1.8f);
  pointLight8.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  pointLight8.specular = glm::vec3(8.0f, 8.0f, 8.0f);
  pointLight8.constant = 1.0f;
  pointLight8.linear = 0.09f;
  ...
  pointLight9.ambient = glm::vec3(1.8f, 1.8f, 1.8f);
  pointLight9.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  pointLight9.specular = glm::vec3(8.0f, 8.0f, 8.0f);
  pointLight9.constant = 1.0f;
  pointLight9.linear = 0.09f;
  ...
  pointLight10.ambient = glm::vec3(1.8f, 1.8f, 1.8f);
  pointLight10.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  pointLight10.specular = glm::vec3(8.0f, 8.0f, 8.0f);
  pointLight10.constant = 1.0f;
  pointLight10.linear = 0.09f;
  ...
  pointLight11.ambient = glm::vec3(7.8f, 7.8f, 7.8f);
  pointLight11.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  pointLight11.specular = glm::vec3(8.0f, 8.0f, 8.0f);
  pointLight11.constant = 1.0f;
  pointLight11.linear = 0.09f;
  ...
  pointLight12.ambient = glm::vec3(7.8f, 7.8f, 7.8f);
  pointLight12.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  pointLight12.specular = glm::vec3(8.0f, 8.0f, 8.0f);
  pointLight12.constant = 1.0f;
  pointLight12.linear = 0.09f;
  ...
  pointLight13.ambient = glm::vec3(7.8f, 7.8f, 7.8f);
  pointLight13.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  pointLight13.specular = glm::vec3(8.0f, 8.0f, 8.0f);
  pointLight13.constant = 1.0f;
  pointLight13.linear = 0.09f;
  ...
  pointLight14.ambient = glm::vec3(7.8f, 7.8f, 7.8f);
  pointLight14.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  pointLight14.specular = glm::vec3(8.0f, 8.0f, 8.0f);
  pointLight14.constant = 1.0f;
  pointLight14.linear = 0.09f;
  ...
  pointLight15.ambient = glm::vec3(7.8f, 7.8f, 7.8f);
  pointLight15.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  pointLight15.specular = glm::vec3(8.0f, 8.0f, 8.0f);
  pointLight15.constant = 1.0f;
  pointLight15.linear = 0.09f;
  ...
  pointLight16.ambient = glm::vec3(7.8f, 7.8f, 7.8f);
  pointLight16.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  pointLight16.specular = glm::vec3(8.0f, 8.0f, 8.0f);
  pointLight16.constant = 1.0f;
  pointLight16.linear = 0.09f;
  ...
  pointLight17.ambient = glm::vec3(7.8f, 7.8f, 7.8f);
  pointLight17.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  pointLight17.specular = glm::vec3(8.0f, 8.0f, 8.0f);
  pointLight17.constant = 1.0f;
  pointLight17.linear = 0.09f;
  ...
  pointLight18.ambient = glm::vec3(7.8f, 7.8f, 7.8f);
  pointLight18.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  pointLight18.specular = glm::vec3(8.0f, 8.0f, 8.0f);
  pointLight18.constant = 1.0f;
  pointLight18.linear = 0.09f;
  ...
  pointLight19.ambient = glm::vec3(7.8f, 7.8f, 7.8f);
  pointLight19.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  pointLight19.specular = glm::vec3(8.0f, 8.0f, 8.0f);
  pointLight19.constant = 1.0f;
  pointLight19.linear = 0.09f;
  ...
  pointLight20.ambient = glm::vec3(7.8f, 7.8f, 7.8f);
  pointLight20.diffuse = glm::vec3(2.05f, 2.05f, 2.05f);
  pointLight20.specular = glm::vec3(8.0f, 8.0f, 8.0f);
  pointLight20.constant = 1.0f;
  pointLight20.linear = 0.09f;
