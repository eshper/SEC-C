...
int main()
{
  ...
  Model skybox("./Models/skybox/skybox.obj");

  Model tablesCirc("./Models/tables/tableCircular.obj");
  Model tablesLong("./Models/tables/tableLong.obj");
  Model tablesOval("./Models/tables/tableOval.obj");
  Model seatsSquare("./Models/seats/seatSquare.obj");
